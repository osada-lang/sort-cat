...
public class ImageCropper {
    public static void CropAndTransparent(string path, int threshold) {
        ...
        try {
            ...
            if (!found) {
                Console.WriteLine("No content found below threshold.");
                return;
            }
            ...
            // Make near-white transparent in the cropped bitmap
            ...
            Console.WriteLine("Cropped and saved.");
        } catch (Exception ex) {
...
[ImageCropper]::CropAndTransparent($filePath, 240)
